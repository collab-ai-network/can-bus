...
fn get_total_supply() {
	ExtBuilder::default()
		...
		.execute_with(|| {
			...
			precompiles()
				.prepare_test(CryptoAlith, LocalAssetId(0u128), PrecompileCall::total_supply {})
		...
		.execute_with(|| {
			...
			precompiles()
				.prepare_test(
					CryptoAlith,
					LocalAssetId(0u128),
					PrecompileCall::balance_of { who: Address(CryptoAlith.into()) },
				)
				.expect_cost(0) // TODO: Test db read/write costs
				.expect_no_logs()
				.execute_returns(U256::from(1000u64));
		...
		.execute_with(|| {
			...
			precompiles()
				.prepare_test(
					CryptoAlith,
					LocalAssetId(0u128),
					PrecompileCall::balance_of { who: Address(Bob.into()) },
				)
				.expect_cost(0) // TODO: Test db read/write costs
				.expect_no_logs()
		...
		.execute_with(|| {
			...
			precompiles()
				.prepare_test(
					CryptoAlith,
					LocalAssetId(0u128),
					PrecompileCall::approve { spender: Address(Bob.into()), value: 500.into() },
				)
				.expect_log(log3(
					LocalAssetId(0u128),
		...
		.execute_with(|| {
			...
			precompiles()
				.prepare_test(
					CryptoAlith,
					LocalAssetId(0u128),
					PrecompileCall::approve { spender: Address(Bob.into()), value: U256::MAX },
				)
				.expect_log(log3(
					LocalAssetId(0u128),
					SELECTOR_LOG_APPROVAL,
		...
		.execute_with(|| {
			...
			precompiles()
				.prepare_test(
					CryptoAlith,
					LocalAssetId(0u128),
					PrecompileCall::transfer { to: Address(Bob.into()), value: 400.into() },
				)
				.expect_log(log3(
					LocalAssetId(0u128),
					SELECTOR_LOG_TRANSFER,
		...
		.execute_with(|| {
			...
			precompiles()
				.prepare_test(
					Charlie,
					LocalAssetId(0u128),
					PrecompileCall::balance_of { who: Address(Charlie.into()) },
				)
				.expect_cost(0) // TODO: Test db read/write costs
				.expect_no_logs()
				.execute_returns(U256::from(400));
		...
		.execute_with(|| {
			...
			precompiles()
				.prepare_test(
					CryptoAlith,
					LocalAssetId(0u128),
					PrecompileCall::approve { spender: Address(Bob.into()), value: 300.into() },
				)
				.expect_log(log3(
					LocalAssetId(0u128),
					SELECTOR_LOG_APPROVAL,
...
fn get_metadata() {
	ExtBuilder::default()
		...
		.execute_with(|| {
			...
			precompiles()
				.prepare_test(CryptoAlith, LocalAssetId(0u128), PrecompileCall::decimals {})
				.expect_cost(0) // TODO: Test db read/write costs
				.expect_no_logs()
...
fn minimum_balance_is_right() {
	ExtBuilder::default().build().execute_with(|| {
		...
		precompiles()
			.prepare_test(CryptoAlith, LocalAssetId(0u128), PrecompileCall::minimum_balance {})
			.expect_cost(0) // TODO: Test db read/write costs
			.expect_no_logs()
